...
Then copy and paste the release notes and the artifacts (e.g.,
`gh release download v1.3.3 --dir tmp/gh/v1.3.3`) into the Codeberg release.
...
- The Linux x86_64 runner is `ubuntu-22.04` (glibc 2.35) for portability.
